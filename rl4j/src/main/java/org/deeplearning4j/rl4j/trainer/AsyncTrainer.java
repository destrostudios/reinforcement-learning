...
public class AsyncTrainer<OBSERVATION extends Observation, ACTION extends Action> implements Trainer {

    private final Builder<LearningAgent<OBSERVATION, ACTION>> agentLearnerBuilder;
    private final Predicate<AsyncTrainer<OBSERVATION,ACTION>> stoppingCondition;
     ...
     */
    @lombok.Builder
    public AsyncTrainer(@NonNull Builder<LearningAgent<OBSERVATION,ACTION>> agentLearnerBuilder,
                        @NonNull Predicate<AsyncTrainer<OBSERVATION,ACTION>> stoppingCondition,
                        int numThreads) {
    ...
    private class AgentLearnerThread extends Thread {
        private final LearningAgent<OBSERVATION,ACTION> agentLearner;
        private final int deviceNum;

        public AgentLearnerThread(LearningAgent<OBSERVATION,ACTION> agentLearner, int deviceNum) {
