 ...
 *  *****************************************************************************
 */
package org.deeplearning4j.rl4j.environment.observation.transform;
...
public class TransformProcess<OBSERVATION extends Observation> {
    ...
    private TransformProcess(Builder builder, String... channelNames) {
        ...
        Class<?>[] typeArguments = TypeResolver.resolveRawArguments(TransformProcess.class, getClass());
        this.observationType = (Class<OBSERVATION>) typeArguments[0];
	...
	public OBSERVATION transform(Map<String, Object> channelsData, int currentObservationStep, boolean isFinalObservation) {
        ...
        return (OBSERVATION) createObservation().fromArray(data);
    }
    ...
    {    	
        try
        {
            return (OBSERVATION) observationType.getDeclaredConstructor().newInstance();
        }
        catch (Exception e)
        {
    ...
    public static class Builder<OBSERVATION extends Observation> {
         ...
         */
        public Builder<OBSERVATION> filter(FilterOperation filterOperation) {
         ...
         */
        public Builder<OBSERVATION> transform(String targetChannel, Operation transformOperation) {
         ...
         */
        public Builder<OBSERVATION> preProcess(String targetChannel, DataSetPreProcessor dataSetPreProcessor) {
            Preconditions.checkNotNull(targetChannel, "The targetChannel must not be null");
         ...
         */
        public TransformProcess<OBSERVATION> build(String... channelNames) {
            ...
            return new TransformProcess<OBSERVATION>(this, channelNames);
        }
    }
