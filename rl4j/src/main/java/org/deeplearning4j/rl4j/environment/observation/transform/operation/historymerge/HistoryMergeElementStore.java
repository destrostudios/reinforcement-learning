 ...
 *  *****************************************************************************
 */
package org.deeplearning4j.rl4j.environment.observation.transform.operation.historymerge;
...
public interface HistoryMergeElementStore {
    ...
    /**
     * Used to tell the HistoryMergeTransform that the store is ready. The HistoryMergeTransform will tell the {@link org.deeplearning4j.rl4j.environment.observation.transform.TransformProcess TransformProcess}
