...
public interface ExperienceHandler<OBSERVATION extends Observation, ACTION extends Action, EXPERIENCE> {
    void addExperience(OBSERVATION observation, ACTION action, double reward, boolean isTerminal);
     ...
     */
    List<EXPERIENCE> generateTrainingBatch();
