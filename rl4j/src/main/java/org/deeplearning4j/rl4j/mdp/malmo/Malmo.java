...
public class Malmo implements Environment<IntegerAction> {
    ...
    /**
     * Create a Malmo using a XML-file mission description and minimal set of parameters.
     * Equivalent to Malmo( loadMissionXML( missionFileName ), missionRecord, actionSpace, observationSpace, framePolicy, clientPool )
     ...
     */
    public Malmo(String missionFileName, MalmoActionSpace actionSpace, MalmoObservationSpace observationSpace,
    ...
    /**
     * Create a fully specified Malmo
     ...
     */
    public Malmo(MissionSpec mission, MissionRecordSpec missionRecord, MalmoActionSpace actionSpace,
    ...
    public Map<String, Object> reset() {
        ...
        last_observation = observationSpace.decode(last_world_state);
        		
		Map<String, Object> channelsData = new HashMap<String, Object>() {
			{
				put("data", last_observation);
			}
		};
    ...
    public StepResult step(IntegerAction action) {
		...
		return new StepResult(channelsData, getRewards(last_world_state), isEpisodeFinished());
    }
