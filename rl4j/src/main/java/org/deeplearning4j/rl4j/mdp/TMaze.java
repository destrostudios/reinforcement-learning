...
public class TMaze implements Environment<IntegerAction> {
    ...
    public TMaze(int lengthOfMaze, Random rnd) {
        this.lengthOfMaze = lengthOfMaze;
        this.rnd = rnd;

        this.space = new IntegerActionSpace(NUM_ACTIONS, ACTION_RIGHT, rnd);
    }
