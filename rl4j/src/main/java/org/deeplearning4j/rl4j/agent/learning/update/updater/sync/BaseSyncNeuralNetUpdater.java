...
public abstract class BaseSyncNeuralNetUpdater<RESULT> implements NeuralNetUpdater<RESULT> {
    protected final TrainableNeuralNet current;
    private final TrainableNeuralNet target;

    private final int targetUpdateFrequency;
    private int updateCount = 0;

    protected BaseSyncNeuralNetUpdater(@NonNull TrainableNeuralNet current,
                                       @NonNull TrainableNeuralNet target,
